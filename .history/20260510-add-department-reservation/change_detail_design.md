...
|---|---|---|---|---|
| [追加] | `DS-MD-ASSET-RESERVATION-MANAGEMENT-BZ-ASSET-RESERVATION-MANAGEMENT` | `backend/app` | 予約・貸出整合処理の実装配置 | `RQ-FT-REGISTER-RESERVATION` |
...
| 区分 | DS-ID | 規約 | 対応RQ-ID |
|---|---|---|---|
| [追加] | `DS-MD-READ-ONLY-EXTERNAL-DEPARTMENT-DB-EX-READ-ONLY-EXTERNAL-DEPARTMENT-DB` | 外部DBアクセスは `external/neon-postgres/src` の関数経由のみ使用し、直接接続を禁止する | `RQ-EX-CONNECT-EXTERNAL-DEPARTMENT-DB` |
